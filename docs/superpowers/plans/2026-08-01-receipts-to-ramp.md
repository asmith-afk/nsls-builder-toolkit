...
**Files:**
- Create: `skills/receipts/scripts/txn_queue.py`
- Create: `skills/receipts/tests/test_txn_queue.py`
...
Run: `cd ~/nsls-skills/nsls-personal-toolkit && python3.12 skills/receipts/tests/test_txn_queue.py`
Expected: FAIL with `ModuleNotFoundError: No module named 'txn_queue'`
...
```bash
git add skills/receipts/scripts/txn_queue.py skills/receipts/tests/test_txn_queue.py
